...
class Model(object):
    ...
    #读取用类创建对象（实例化）的DataSet类作为进行训练的数据源
    ...
    def train_model(self):
        self.model.compile(
            optimizer='adam',  #也可RMSprop,Adagrad，豪神你也可以试试哪个好，我个人感觉差异不大
            loss='squared_hingecategorical_crossentropy',  #也可categorical_crossentropy作为loss看看哪个好
            metrics=['accuracy'])
